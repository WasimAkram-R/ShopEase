...
//       <button  onClick={() => setSmShow(true)}  className='buttons rounded-3  border-0 p-3 w-100 fw-bold fs-6 mt-3' style={{backgroundColor: "#93ab01"}}>PLACE ORDER<IoIosArrowRoundForward style={{width:"30px",height:"30px",color:"white" }}/></button>
...
//           </Modal.Title> */}
//         </Modal.Header>
//         <Modal.Body className='text-uppercase bg-dark text-white'>Your order has been placed</Modal.Body>
//       </Modal>
   ...
   <div className='w-100'>
    ...
    <input type="text" id="Postcodezip "placeholder='Postcode / Zip' className='p-2 w-100  mb-4' required/>
            ...
            <div className="col-lg-6 p-4 border border-4">
              ...
              <div className="row border-bottom border-black-50 py-3">
                <div className="col-6"><h6>Shipping</h6></div>
                <div className="col-6"><label><input type="radio" name="shipping" /> Free Shipping</label></div>
              </div>

              <div className="row border-bottom border-black-50 py-3">
                <div className="col-6"><h6>Order Total</h6></div>
                <div className="col-6"><h6>&#8377;{total}</h6></div>
              </div>
                ...
                <div className="col-12">
                  {/* <Accordion defaultActiveKey="0">
                    ...
                    <Accordion.Item eventKey="0">
                      <Accordion.Header>Direct Bank Transfer</Accordion.Header>
                      <Accordion.Body>Instructions for bank transfer.</Accordion.Body>
                    </Accordion.Item>
